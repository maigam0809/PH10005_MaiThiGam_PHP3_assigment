            ...
            <div class="col-lg-5" style="padding-bottom:120px">
                ...
                <form method="post" action="{{route('admin.products.update',['product'=>$product->id])}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" value="{{$product->name}}" id="name1">
                        @error('name')
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="intro" class="form-control" value="{{ $product->intro }}" id="name1">
                        @error('intro')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="detail" class="form-control" value="{{$product->detail}}" id="name1">
                        @error('detail')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <textarea  class="form-control ckeditor" rows="1" id="detail" name="description">{{ $product->description}}</textarea>
                        @error('description')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
