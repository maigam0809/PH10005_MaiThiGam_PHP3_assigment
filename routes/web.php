...
Route::group(['middleware'=>['check_login']],function(){
    Route::group(['prefix' =>'admin','as' => 'admin.','namespace' =>'Admin'],function(){
        ...
        //     Route::get('edit/{product}','InvoiceController@edit')->name('edit');
        //     Route::post('update/{product}','InvoiceController@update')->name('update');
        //     Route::get('/{product}','InvoiceController@show')->name('show');
        //     Route::post('delete/{product}','InvoiceController@delete')->name('delete');
        // });
